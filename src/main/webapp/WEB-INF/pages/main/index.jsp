    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element mylogo">
                            <span>
                            	<img alt="image" class="img-circle" width="80px" height="80px" src="http://localhost:8080/${sessionScope.activeUser.pic}" />
                            </span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${sessionScope.activeUser.ename}</strong></span>
                               <span class="text-muted text-xs block">${sessionScope.activeUser.rolename}<b class="caret"></b></span>
                               </span>
                            </a>
                    ...
                    <c:forEach var="sources" items="${sourceList}">
                    <li>
                        <a href="#">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="${pageContext.request.contextPath}/exitSystem" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${pageContext.request.contextPath}/main/index_v148b2" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <!--
